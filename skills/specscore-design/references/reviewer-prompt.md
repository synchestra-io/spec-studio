...
Use this template when dispatching a spec document reviewer subagent from `specscore:design`. Purpose: verify the Feature is complete, consistent, and ready for `writing-plans`.
